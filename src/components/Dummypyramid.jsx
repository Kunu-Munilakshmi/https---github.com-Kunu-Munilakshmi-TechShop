...
// const Dummypyramid = ({ productsData }) => {
...
//                     // Determine scale directly based on index
//                     let scale = 0.6; // Default scale
//                     if (index === currentSlide) scale = 1; // Center slide
//                     else if (Math.abs(index - currentSlide) === 1 ||
//                         Math.abs(index - currentSlide) === fproductsData.length - 1) {
//                         scale = 0.8; // Adjacent slides
//                     }
